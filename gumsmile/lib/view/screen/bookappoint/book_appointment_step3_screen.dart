...
class _BookAppointmentStep3ScreenState extends State<BookAppointmentStep3Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('STEP 3 OUT OF 3', style: Constant().textAppBar), 
          centerTitle: true,
          elevation: 0,
          backgroundColor: kPrimaryColor,
        ),
        body: Consumer<BookAppointmentProvider>(builder: (context, bookProv, _) {
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(
                  gradient: LinearGradient(
                      ...
                      colors: [
                    Color.fromARGB(225, 239, 254, 254),
                    Colors.white
                  ])),
              child: Column(
                ...
                children: [
                  ...
                  Center(
                      child: Text('IDR ${bookProv.selectedTreatment!.price}',
